...
class LoginWhatsappWidget extends StatefulWidget {
  const LoginWhatsappWidget({super.key});

  @override
  State<LoginWhatsappWidget> createState() => _LoginWhatsappWidgetState();
}

class _LoginWhatsappWidgetState extends State<LoginWhatsappWidget> {
                  ...
                  onTap: () {
                    if (isDisabled) {
                      ...
                      Provider.of<AuthProvider>(context, listen: false)
                        ...
                        params: CheckHasAccountParams(
                          phoneNumber: userPhoneNumber,
                        ),
                        context: context,
                        phoneNumber: userPhoneNumber,
                      );
                      print(isHasAccount.toString());
                    }
                  },
                  child: Container(
                    padding: const EdgeInsets.symmetric(
